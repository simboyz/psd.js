  ...
  Root.PSD = PSD = (function() {
    ...
    */
    ...
    PSD.prototype.parseLayersMasks = function() {
      var a, bm, chid, chlen, count, extralen, extrastart, i, j, key, l, layerlen, linfo, m, misclen, miscstart, namelen, signature, size, skip, _ref, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
        ...
        if (layerlen) {
          ...
          for (i = 0, _ref = this.numLayers; 0 <= _ref ? i < _ref : i > _ref; 0 <= _ref ? i++ : i--) {
            ...
            */
            ...
            for (j = 0, _ref4 = l.channels; 0 <= _ref4 ? j < _ref4 : j > _ref4; 0 <= _ref4 ? j++ : j--) {
              _ref5 = this.readf(">hL"), chid = _ref5[0], chlen = _ref5[1];
              l.chids.push(chid);
            ...
            */
            bm = {};
            _ref6 = this.readf(">4s4sBBBB"), bm.sig = _ref6[0], bm.key = _ref6[1], bm.opacity = _ref6[2], bm.clipping = _ref6[3], bm.flags = _ref6[4], bm.filler = _ref6[5];
            ...
            */
            ...
            if (m.size) {
              _ref7 = this.readf(">LLLLBB"), m.top = _ref7[0], m.left = _ref7[1], m.bottom = _ref7[2], m.right = _ref7[3], m.default_color = _ref7[4], m.flags = _ref7[5];
              this.seek(m.size - 18);
              _ref8 = [m.bottom - m.top, m.right - m.left], m.rows = _ref8[0], m.cols = _ref8[1];
            }
            l.mask = m;
            ...
            */
            ...
            _ref9 = this.readf(">4s4s4s"), signature = _ref9[0], key = _ref9[1], size = _ref9[2];
            if (key === "luni") {
              namelen = this.i32(this.read(4));
              namelen += namelen % 2;
              l.name = "";
              for (count = 0, _ref10 = namelen - 1; 0 <= _ref10 ? count < _ref10 : count > _ref10; 0 <= _ref10 ? count++ : count--) {
          ...
          for (i = 0, _ref11 = this.numLayers; 0 <= _ref11 ? i < _ref11 : i > _ref11; 0 <= _ref11 ? i++ : i--) {
            ...
            if (linfo[i].channels === 2) {
              ...
              if (typeof this.images[i][3] === "number") {} else {
    ...
    PSD.prototype.parseImage = function(li, isLayer) {
      ...
      return Log.debug("# Image: " + li.name + "/" + li.channels);
    };

    PSD.prototype.parseChannel = function(li, idx, count, rows, cols, depth) {};
